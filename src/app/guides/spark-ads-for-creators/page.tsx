      ...
      <div className="container-custom max-w-4xl py-12 space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div className="p-5 bg-tiktok-pink/10 rounded-lg">
              ...
              <ul className="space-y-2 text-body-sm text-neutral-700">
                <li>❌ Clearly labeled "Sponsored"</li>
                <li>❌ No profile link visible</li>
                <li>❌ Can't interact with original post</li>
                <li>❌ Engagement doesn't benefit creator</li>
                <li>❌ Feels like traditional advertising</li>
              </ul>
            </div>
            <div className="p-5 bg-green-50 rounded-lg">
              <h3 className="font-semibold text-neutral-900 mb-3">How Spark Ads Work:</h3>
              <ul className="space-y-2 text-body-sm text-neutral-700">
                <li>✅ Subtle "Sponsored" label</li>
                <li>✅ Links to creator's profile</li>
                <li>✅ Users can like, comment, share</li>
                <li>✅ Engagement benefits creator's metrics</li>
                <li>✅ Looks like organic content</li>
              </ul>
            </div>
          </div>
        ...
        <Card>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="space-y-2 text-body-sm text-neutral-700">
                <li>✅ Negotiate both upfront fee AND performance bonus (dual revenue streams)</li>
                <li>✅ Ask for minimum guaranteed payment even if performance is low</li>
                <li>✅ Request reporting access to track your Spark Ad performance</li>
                <li>✅ Limit authorization duration (30-90 days typical)</li>
                <li>✅ Charge more for high-performing content (already proven engagement)</li>
                <li>✅ Bundle: "3 posts + Spark Ads rights" package deals</li>
                <li>✅ Add renewal fees if brand wants to extend Spark Ad campaign</li>
              </ul>
            </div>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-neutral-900 mb-3">✅ Do This:</h3>
              <ul className="space-y-2 text-body-sm text-neutral-700">
            ...
            <div>
              <h3 className="font-semibold text-neutral-900 mb-3">❌ Avoid This:</h3>
